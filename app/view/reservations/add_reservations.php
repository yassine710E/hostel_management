                ...
                <table class="min-w-full bg-white border">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <a href="/reservations/validee/<?= $obj_chambre->id_chambre ?>/<?= $_POST['id_client'] ?>/<?= $_POST['Code_reservation'] ?>/<?= $_POST['date_depart'] ?>/<?= $_POST['date_arrivee'] ?>/<?= $_POST['nbr_adultes_enfants'] ?>"
